...
orderSelect = (order) => (e) => {
  ...
  openMap = () => {
    if (this.state.maplink === "") {
      ...
      this.props.errorDialog({
        label: 'У первого заказа нет координат места назначения. К сожалению, автоматическое построение маршрута невозможно. Вы можете скопировать адрес и вставить его в навигатор.',
